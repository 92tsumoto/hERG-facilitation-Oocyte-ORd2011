...
struct varstruct {
	...
	double block_rate,fraction_facilitation;
	double ic50,hillc,fic50,fhillc;
...
// Rapid activating potassium current (Ikr) (non-facilitation component)
struct ikrstruct {
...
// Rapid activating potassium current (Ikr) (facilitation component)
struct ikr2struct {
