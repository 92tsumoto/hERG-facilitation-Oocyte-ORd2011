...
void comp_ikr (double x[])
{
	...
	ikr.ik = var.block_rate*var.fraction_facilitation*ikr.Gkr*ikr.rategkr*ikr.xr*ikr.rkr*(x[0]-var.Ek);

}

// Rapidly Activating Potassium Current (facilitation component)
void comp_ikr2 (double x[])
{
	...
	ikr2.xrss = ikr2.Txrss[iV]*d2 + ikr2.Txrss[iV+1]*d1;
	ikr2.tauxr_fast = ikr2.Ttauxr_fast[iV]*d2 + ikr2.Ttauxr_fast[iV+1]*d1;
	ikr2.tauxr_slow = ikr2.Ttauxr_slow[iV]*d2 + ikr2.Ttauxr_slow[iV+1]*d1;
	ikr2.Axr_fast = ikr2.TAxr_fast[iV]*d2 + ikr2.TAxr_fast[iV+1]*d1;
	ikr2.Axr_slow = 1.0 - ikr2.Axr_fast;
	ikr2.rkr = ikr2.Trkr[iV]*d2 + ikr2.Trkr[iV+1]*d1;

	ikr2.xr = ikr2.Axr_fast*x[41] + ikr2.Axr_slow*x[42];

	ikr2.ik = var.block_rate*(1.0-var.fraction_facilitation)*ikr.Gkr*ikr.rategkr*ikr2.xr*ikr2.rkr*(x[0]-var.Ek);
