...
void comp_ikr (double x[])
{
	...
	ikr.ik = var.block_rate*var.fraction_facilitation*ikr.Gkr*ikr.rategkr*x[25]*ikr.rkr*(x[0]-var.Ek);
...
void comp_ikr2 (double x[])
{
	...
	ikr2.tauxr = ikr2.Ttauxr[iV]*d2 + ikr2.Ttauxr[iV+1]*d1;
	ikr2.rkr = ikr2.Trkr[iV]*d2 + ikr2.Trkr[iV+1]*d1;

	ikr2.xr = x[41];

	ikr2.ik = var.block_rate*(1.0-var.fraction_facilitation)*ikr.Gkr*ikr.rategkr*x[41]*ikr2.rkr*(x[0]-var.Ek);
